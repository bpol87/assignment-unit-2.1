...
let food = "Mediterranean Cuisine"
console.log(food);
...
if (pets > friendsPets){
 mostPets = pets;
  ...
  mostPets = "My friend and I have the same numnber of pets!"
} else {
...
result = adventurous ? "Adventures are great!" : "Why dont we stay home?" ;
console.log(result);
